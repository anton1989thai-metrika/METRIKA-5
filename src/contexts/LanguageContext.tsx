...
const translations: Record<string, Translations> = {
  ...
  th: {
    ...
    objects: {
      ...
      china: "จีน",
      thailand: "ไทย",
      rentFilterActive: "แสดงอสังหาริมทรัพย์สำหรับเช่า"
    },
    purchaseApplication: {
      title: "ใบสมัครซื้ออสังหาริมทรัพย์",
      description: "ส่งใบสมัครซื้ออสังหาริมทรัพย์",
      instructions: "กรอกแบบฟอร์มด้านล่าง และผู้เชี่ยวชาญของเราจะติดต่อคุณภายใน 24 ชั่วโมงเพื่อหารือเกี่ยวกับความต้องการของคุณ",
      ...
      emailPlaceholder: "example@email.com",
      propertyType: "ประเภทอสังหาริมทรัพย์",
      selectPropertyType: "เลือกประเภทอสังหาริมทรัพย์",
      budget: "งบประมาณ",
      budgetPlaceholder: "ระบุงบประมาณของคุณ",
      preferredLocation: "ตำแหน่งที่ต้องการ",
      preferredLocationPlaceholder: "เขต, รถไฟใต้ดิน, ที่อยู่",
      additionalInfo: "ข้อมูลเพิ่มเติม",
      additionalInfoPlaceholder: "บอกเราเกี่ยวกับความต้องการอสังหาริมทรัพย์ของคุณ",
      submit: "ส่งใบสมัคร",
      cancel: "ยกเลิก",
      contactInfo: "ต้องการความช่วยเหลือ? ติดต่อเรา:"
    },
    map: {
  ...
  hy: {
    ...
    objects: {
      ...
      china: "Չինաստան",
      thailand: "Թաիլանդ",
      rentFilterActive: "Ցուցադրվում են վարձակալության օբյեկտներ"
    },
    purchaseApplication: {
      title: "Անշարժ գույքի գնման դիմում",
      description: "Ներկայացրեք անշարժ գույքի գնման դիմում",
      instructions: "Լրացրեք ստորև նշված ձևը, և մեր մասնագետը կապ կհաստատի ձեզ հետ 24 ժամվա ընթացքում ձեր կարիքները քննարկելու համար:",
      fullName: "Ամբողջական անուն",
      fullNamePlaceholder: "Մուտքագրեք ձեր ամբողջական անունը",
      phone: "Հեռախոս",
      phonePlaceholder: "+7 (___) ___-__-__",
      email: "Էլ. փոստ",
      emailPlaceholder: "example@email.com",
      propertyType: "Անշարժ գույքի տեսակ",
      selectPropertyType: "Ընտրեք անշարժ գույքի տեսակը",
      budget: "Բյուջե",
      budgetPlaceholder: "Նշեք ձեր բյուջեն",
      preferredLocation: "Նախընտրելի գտնվելու վայր",
      preferredLocationPlaceholder: "Շրջան, մետրո, հասցե",
      additionalInfo: "Լրացուցիչ տեղեկություն",
      additionalInfoPlaceholder: "Պատմեք մեզ ձեր անշարժ գույքի պահանջների մասին",
      submit: "Ներկայացնել դիմում",
      cancel: "Չեղարկել",
      contactInfo: "Օգնության կարիք ունեք? Կապվեք մեզ հետ:"
    },
    map: {
  ...
  az: {
    ...
    objects: {
      ...
      china: "Çin",
      thailand: "Tayland",
      rentFilterActive: "İcarəyə verilən əmlaklar göstərilir"
    },
    purchaseApplication: {
      title: "Əmlak alış müraciəti",
      description: "Əmlak alış müraciəti göndərin",
      instructions: "Aşağıdakı formu doldurun və mütəxəssisimiz 24 saat ərzində sizinlə əlaqə saxlayaraq ehtiyaclarınızı müzakirə edəcək.",
      fullName: "Tam ad",
      ...
      emailPlaceholder: "example@email.com",
      propertyType: "Əmlak növü",
      selectPropertyType: "Əmlak növünü seçin",
      budget: "Büdcə",
      budgetPlaceholder: "Büdcənizi göstərin",
      preferredLocation: "Üstünlük verilən yer",
      preferredLocationPlaceholder: "Rayon, metro, ünvan",
      additionalInfo: "Əlavə məlumat",
      additionalInfoPlaceholder: "Əmlak tələbləriniz haqqında bizə məlumat verin",
      submit: "Müraciəti göndər",
      cancel: "Ləğv et",
      contactInfo: "Köməyə ehtiyacınız var? Bizimlə əlaqə saxlayın:"
    },
    map: {
  ...
  zh: {
    ...
    objects: {
      ...
      china: "中国",
      thailand: "泰国",
      rentFilterActive: "显示租赁房产"
    },
    purchaseApplication: {
      title: "房地产购买申请",
      description: "提交房地产购买申请",
      instructions: "请填写下面的表格，我们的专家将在24小时内与您联系，讨论您的需求。",
      fullName: "全名",
      ...
      budget: "预算",
      budgetPlaceholder: "请指定您的预算",
      preferredLocation: "首选位置",
      preferredLocationPlaceholder: "区域、地铁、地址",
      additionalInfo: "附加信息",
      additionalInfoPlaceholder: "请告诉我们您的房产要求",
      submit: "提交申请",
      cancel: "取消",
      contactInfo: "需要帮助？请联系我们："
    },
    map: {
      title: "交互式地图",
  ...
  ko: {
    ...
    objects: {
      ...
      china: "중국",
      thailand: "태국",
      rentFilterActive: "임대용 부동산이 표시됩니다"
    },
    purchaseApplication: {
      title: "부동산 구매 신청서",
      description: "부동산 구매 신청서를 제출하세요",
      instructions: "아래 양식을 작성하시면 저희 전문가가 24시간 내에 연락하여 귀하의 요구사항을 논의할 것입니다.",
      fullName: "전체 이름",
      ...
      emailPlaceholder: "example@email.com",
      propertyType: "부동산 유형",
      selectPropertyType: "부동산 유형을 선택하세요",
      budget: "예산",
      budgetPlaceholder: "예산을 지정하세요",
      preferredLocation: "선호하는 위치",
      preferredLocationPlaceholder: "지역, 지하철, 주소",
      additionalInfo: "추가 정보",
      additionalInfoPlaceholder: "부동산 요구사항에 대해 알려주세요",
      submit: "신청서 제출",
      cancel: "취소",
      contactInfo: "도움이 필요하신가요? 저희에게 연락하세요:"
    },
    map: {
      title: "대화형 지도",
  ...
  ja: {
    ...
    objects: {
      ...
      china: "中国",
      thailand: "タイ",
      rentFilterActive: "賃貸物件が表示されています"
    },
    purchaseApplication: {
      title: "不動産購入申請書",
      description: "不動産購入申請書を提出してください",
      instructions: "以下のフォームに記入していただければ、専門家が24時間以内にご連絡し、ご要望についてご相談いたします。",
      fullName: "フルネーム",
      ...
      emailPlaceholder: "example@email.com",
      propertyType: "不動産タイプ",
      selectPropertyType: "不動産タイプを選択してください",
      budget: "予算",
      budgetPlaceholder: "予算を指定してください",
      preferredLocation: "希望する場所",
      preferredLocationPlaceholder: "地区、地下鉄、住所",
      additionalInfo: "追加情報",
      additionalInfoPlaceholder: "不動産のご要望についてお聞かせください",
      submit: "申請書を提出",
      cancel: "キャンセル",
      contactInfo: "お手伝いが必要ですか？お気軽にお問い合わせください："
    },
    map: {
      title: "インタラクティブマップ",
  ...
  kk: {
    ...
    objects: {
      ...
      china: "Қытай",
      thailand: "Тайланд",
      rentFilterActive: "Жалға берілетін мүліктер көрсетіледі"
    },
    purchaseApplication: {
      title: "Жылжымайтын мүлік сатып алу өтінімі",
      description: "Жылжымайтын мүлік сатып алу өтінімін жіберіңіз",
      instructions: "Төмендегі форманы толтырыңыз, біздің маман 24 сағат ішінде сізбен байланысып, қажеттіліктеріңізді талқылайды.",
      ...
      budget: "Бюджет",
      budgetPlaceholder: "Бюджетіңізді көрсетіңіз",
      preferredLocation: "Үлгілі орналасқан жер",
      preferredLocationPlaceholder: "Аудан, метро, мекенжай",
      additionalInfo: "Қосымша ақпарат",
      additionalInfoPlaceholder: "Мүлік талаптарыңыз туралы бізге айтыңыз",
      submit: "Өтінімді жіберу",
      cancel: "Болдырмау",
      contactInfo: "Көмек керек пе? Бізбен байланысыңыз:"
    },
    map: {
    ...
    realEstateObjects: {
      "1": {
        ...
        address: "Тверская көшесі, 15 үй, 42 пәтер",
        material: "Кірпіш"
      },
      "2": {
        title: "Жеке үй",
        address: "Подмосковная ауылы, Бақ көшесі, 7 үй",
        material: "6 жүздік учаске"
      },
      "3": {
        title: "Кеңсе ғимараты",
        address: "БЦ \"Орталық\", 301 кеңсе",
        material: "Бетон"
      },
      "4": {
        title: "1 бөлмелі пәтер",
        address: "Ленин көшесі, 25 үй, 15 пәтер",
        material: "Панель"
      },
      "5": {
        title: "Жер учаскесі",
        address: "СНТ \"Күншіл\", 12 учаске",
        material: "Электр"
      },
      "6": {
        title: "3 бөлмелі пәтер",
        address: "Мир даңғылы, 8 үй, 67 пәтер",
        material: "Монолит"
      },
      "7": {
        title: "Студия",
        address: "Арбат көшесі, 12 үй, 3 пәтер",
        material: "Кірпіш"
      },
      "8": {
        title: "Коттедж",
        address: "Рублево поселкі, Орман көшесі, 45 үй",
        material: "10 жүздік учаске"
      },
      "9": {
        title: "Сауда ғимараты",
        address: "ТЦ \"Мега\", 15 павильон",
        material: "Сауда орталығы"
      },
      "10": {
        title: "4 бөлмелі пәтер",
        address: "Қызыл Алаң көшесі, 1 үй, 100 пәтер",
        material: "Монолит"
      },
      "11": {
        title: "Гараж",
        address: "Өнеркәсіп көшесі, 5 үй, 12 бокс",
        material: "Бетон"
      },
      "12": {
        title: "2 бөлмелі пәтер",
        address: "Бақ көшесі, 30 үй, 25 пәтер",
        material: "Панель"
      },
      "13": {
        title: "Қойма ғимараты",
        address: "Өнеркәсіп көшесі, 15 үй, 3 қойма",
        material: "Металл конструкция"
      },
      "14": {
        title: "1 бөлмелі пәтер",
        address: "Жаңа көше, 7 үй, 8 пәтер",
        material: "Кірпіш"
      },
      "15": {
        title: "Таунхаус",
        address: "Заречный поселкі, Орталық көше, 12 үй",
        material: "4 жүздік учаске"
      },
      "16": {
        title: "Кеңсе",
        address: "БЦ \"Қазіргі\", 505 кеңсе",
        material: "Шыны/бетон"
      },
      "17": {
        title: "3 бөлмелі пәтер",
        address: "Мәскеу көшесі, 22 үй, 45 пәтер",
        material: "Монолит"
      },
      "18": {
        title: "Жер учаскесі",
        address: "СНТ \"Ромашка\", 8 учаске",
        material: "Газ, электр"
      },
      "19": {
        title: "Студия",
        address: "Жастар көшесі, 18 үй, 2 пәтер",
        material: "Панель"
      },
      "20": {
        title: "Жеке үй",
        address: "Жасыл ауылы, Дача көшесі, 3 үй",
        material: "8 жүздік учаске"
      },
      "21": {
        title: "2 бөлмелі пәтер",
        address: "Парк көшесі, 14 үй, 33 пәтер",
        material: "Кірпіш"
      },
      "22": {
        title: "Өндірістік ғимарат",
        address: "Зауыт көшесі, 25 үй, 2 цех",
        material: "Металл конструкция"
      },
      "23": {
        title: "1 бөлмелі пәтер",
        address: "Мектеп көшесі, 9 үй, 12 пәтер",
        material: "Панель"
      },
      "24": {
        title: "Коттедж",
        address: "Орман поселкі, Қарағай көшесі, 7 үй",
        material: "12 жүздік учаске"
      },
      "25": {
        title: "Кеңсе ғимараты",
        address: "БЦ \"Бизнес\", 201 кеңсе",
        material: "Бетон"
      },
      "26": {
        title: "3 бөлмелі пәтер",
        address: "Көктем көшесі, 11 үй, 56 пәтер",
        material: "Монолит"
      },
      "27": {
        title: "Гараж",
        address: "Автомобиль көшесі, 3 үй, 7 бокс",
        material: "Кірпіш"
      },
      "28": {
        title: "Студия",
        address: "Студент көшесі, 5 үй, 1 пәтер",
        material: "Кірпіш"
      },
      "29": {
        title: "Жер учаскесі",
        address: "СНТ \"Астық\", 25 учаске",
        material: "Барлық коммуникациялар"
      },
      "30": {
        title: "Таунхаус",
        address: "Күншіл поселкі, Анық көше, 9 үй",
        material: "5 жүздік учаске"
      }
    },
    blog: {
      title: "Блог",
      loadMore: "Тағы мақалалар жүктеу",
      readMore: "Толығырақ оқу →",
      published: "Жарияланған:",
      articles: {
        "1": {
          title: "Жаңа ғимаратта пәтерді дұрыс таңдау жолдары",
          date: "15 қаңтар 2024",
          excerpt: "Жаңа ғимаратта пәтерді таңдау кезінде жоспарлаудан бастап құрылысшының беделіне дейін көптеген факторларға назар аудару маңызды. Бұл мақалада дұрыс таңдауға көмектесетін негізгі сәттерді айтып береміз..."
        },
        "2": {
          title: "2024 жылдағы жылжымайтын мүлік нарығының трендтері",
          date: "10 қаңтар 2024",
          excerpt: "Жылжымайтын мүлік нарығының қазіргі тенденцияларын талдау сатып алушылардың қалаулары мен баға динамикасында қызықты өзгерістерді көрсетеді. Жаңа жылдың негізгі трендтерін қарастырайық..."
        },
        "3": {
          title: "2024 жылдағы ипотека: не өзгерді?",
          date: "5 қаңтар 2024",
          excerpt: "2024 жылдағы ипотекалық несиелендірудің жаңа шарттары әлеуетті қарыз алушылар үшін оң және теріс өзгерістерді әкелді. Барлық жаңалықтарды талдайық..."
        }
      }
    }
  },
  uz: {
    ...
    objects: {
      ...
      china: "Xitoy",
      thailand: "Tailand",
      rentFilterActive: "Ijaraga beriladigan mulklar ko'rsatilmoqda"
    },
    purchaseApplication: {
      title: "Ko'chmas mulk sotib olish arizasi",
      description: "Ko'chmas mulk sotib olish arizasini yuboring",
      instructions: "Quyidagi formani to'ldiring va bizning mutaxassisimiz 24 soat ichida siz bilan bog'lanib, ehtiyojlaringizni muhokama qiladi.",
      fullName: "To'liq ism",
      ...
      selectPropertyType: "Mulk turini tanlang",
      budget: "Byudjet",
      budgetPlaceholder: "Byudjetingizni ko'rsating",
      preferredLocation: "Afzal ko'rilgan joylashuv",
      preferredLocationPlaceholder: "Tuman, metro, manzil",
      additionalInfo: "Qo'shimcha ma'lumot",
      additionalInfoPlaceholder: "Mulk talablaringiz haqida bizga ayting",
      submit: "Arizani yuborish",
      cancel: "Bekor qilish",
      contactInfo: "Yordam kerakmi? Biz bilan bog'laning:"
    },
    map: {
  ...
  tg: {
    ...
    objects: {
      ...
      china: "Хитой",
      thailand: "Таиланд",
      rentFilterActive: "Объектҳои иҷораи амлок нишон дода мешаванд"
    },
    purchaseApplication: {
      title: "Дархости харидани амлок",
      description: "Дархости харидани амлокро пешниҳод кунед",
      instructions: "Формаи зеринро пур кунед ва мутахассиси мо дар давоми 24 соат бо шумо тамос гирифта, эҳтиёҷоти шуморо муҳокима мекунад.",
      fullName: "Номи пурра",
      fullNamePlaceholder: "Номи пурраи худро ворид кунед",
      phone: "Телефон",
      phonePlaceholder: "+7 (___) ___-__-__",
      email: "Почтаи электронӣ",
      emailPlaceholder: "example@email.com",
      propertyType: "Навъи амлок",
      selectPropertyType: "Навъи амлокро интихоб кунед",
      budget: "Буҷет",
      budgetPlaceholder: "Буҷети худро муайян кунед",
      preferredLocation: "Ҷойи афзалиятнок",
      preferredLocationPlaceholder: "Ноҳия, метро, суроға",
      additionalInfo: "Маълумоти иловагӣ",
      additionalInfoPlaceholder: "Дар бораи талаботи амлок ба мо гуфта диҳед",
      submit: "Пешниҳод кардани дархост",
      cancel: "Бекор кардан",
      contactInfo: "Кӯмак лозим аст? Бо мо тамос гиред:"
    },
    map: {
  ...
  hi: {
    ...
    objects: {
      ...
      china: "चीन",
      thailand: "थाईलैंड",
      rentFilterActive: "किराए के लिए संपत्तियां दिखाई जा रही हैं"
    },
    purchaseApplication: {
      title: "रियल एस्टेट खरीद आवेदन",
      description: "रियल एस्टेट खरीद के लिए आवेदन जमा करें",
      instructions: "नीचे दिया गया फॉर्म भरें और हमारा विशेषज्ञ 24 घंटे के भीतर आपसे संपर्क करके आपकी आवश्यकताओं पर चर्चा करेगा।",
      fullName: "पूरा नाम",
      ...
      budget: "बजट",
      budgetPlaceholder: "अपना बजट निर्दिष्ट करें",
      preferredLocation: "पसंदीदा स्थान",
      preferredLocationPlaceholder: "जिला, मेट्रो, पता",
      additionalInfo: "अतिरिक्त जानकारी",
      additionalInfoPlaceholder: "अपनी संपत्ति आवश्यकताओं के बारे में हमें बताएं",
      submit: "आवेदन जमा करें",
      cancel: "रद्द करें",
      contactInfo: "मदद चाहिए? हमसे संपर्क करें:"
    },
    map: {
