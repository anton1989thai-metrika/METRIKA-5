...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-screen font-sans">
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar px-4 md:px-0 md:w-[820px] mx-auto py-6 space-y-4">
            ...
            <div className="w-full max-w-2xl">
              ...
              <div className="flex flex-wrap gap-2 justify-center px-12">
                <button 
                  ...
                  className="bg-gray-50 border border-gray-300 hover:bg-gray-100 text-black px-3 py-1.5 rounded-full text-xs transition-colors"
                >
                  Составить договор
                </button>
                <button 
      ...
      {messages.length > 0 && (
        <div className="w-full border-t border-gray-300 py-4 px-4 md:px-0 flex justify-center bg-white">
