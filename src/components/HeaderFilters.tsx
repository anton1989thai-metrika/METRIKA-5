...
// Кастомная иконка для Дополнительные удобства (бассейн с лестницей)
const AmenitiesIcon = ({ className }: { className?: string }) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
          ...
          <div className="flex flex-nowrap gap-3 justify-center items-center overflow-x-auto">
            ...
            <div className="flex gap-2">
              <Sheet>
                ...
                <SheetContent className="w-[400px] sm:w-[540px] overflow-y-auto p-6 [&>button]:ml-6 [&>button]:relative [&>button]:left-[295px] [&>button]:top-[-1px] [&>button]:border-0 [&>button]:outline-none [&>button]:ring-0 [&>button]:shadow-none [&>button]:focus:outline-none [&>button]:focus:ring-0 [&>button]:focus:shadow-none [&>button]:focus-visible:outline-none [&>button]:focus-visible:ring-0 [&>button]:focus-visible:shadow-none">
                  ...
                  <Accordion type="single" collapsible className="w-full">
                    ...
                    <AccordionItem value="amenities">
                      <AccordionTrigger className="text-black hover:no-underline flex items-center space-x-3 justify-between text-base font-normal">
                        <div className="flex items-center space-x-3">
                          <AmenitiesIcon className="w-5 h-5" />
