        ...
        <div className="p-6">
          {!isStarted && !showResults && (
            <div className="space-y-6">
              {/* Информация о тесте */}
              <div className="bg-white shadow-sm border border-gray-300 rounded-lg p-6 shadow-lg">
              ...
              <div className="text-center">
                <button
                  onClick={handleStart}
                  className="px-8 py-3 bg-white shadow-sm border border-gray-300 text-black rounded-full shadow-lg hover:shadow-xl transition-all font-medium text-lg"
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between">
                <button
                  ...
                  className="px-4 py-2 bg-white shadow-sm border border-gray-300 text-black rounded-full shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
                  Предыдущий
                </button>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-white shadow-sm border border-gray-300 text-black rounded-full shadow-lg hover:shadow-xl transition-all"
                  >
                  ...
                  {currentQuestion === questions.length - 1 ? (
                    <button
                      ...
                      className="px-6 py-2 bg-white shadow-sm border border-gray-300 text-black rounded-full shadow-lg hover:shadow-xl transition-all font-medium"
                      style={{ backgroundColor: '#fff60b', '--hover-color': '#e6d90a' } as React.CSSProperties}
                      onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#e6d90a'}
                      onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#fff60b'}>
                      Завершить тест
          ...
          {showResults && (
            <div className="space-y-6">
              ...
              <div className={`rounded-lg p-6 text-center shadow-lg border-2 ${
                score >= 70 ? 'bg-white shadow-sm border border-gray-300' : 'bg-white shadow-sm border border-gray-300'
              }`}>
              ...
              <div className="flex justify-center gap-4">
                {score < 70 && test.attempts < test.maxAttempts && (
                  <button
                    ...
                    className="px-6 py-3 bg-white shadow-sm border border-gray-300 text-black rounded-full shadow-lg hover:shadow-xl transition-all font-medium"
                    style={{ backgroundColor: '#fff60b', '--hover-color': '#e6d90a' } as React.CSSProperties}
                    onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#e6d90a'}
                    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#fff60b'}>
