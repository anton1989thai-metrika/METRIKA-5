        ...
        <div className="p-6">
          {!isStarted && !showResults && (
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Информация о тесте</h3>
                <p className="text-gray-600 mb-4">{test.description}</p>
                
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">{test.questions}</div>
                    <div className="text-sm text-gray-500">Вопросов</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">{test.timeLimit}</div>
                    <div className="text-sm text-gray-500">Минут</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">{test.attempts}/{test.maxAttempts}</div>
                    <div className="text-sm text-gray-500">Попыток</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">{test.bestScore || 0}</div>
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                <h4 className="font-semibold text-blue-900 mb-2">Правила прохождения теста</h4>
          ...
          {showResults && (
            <div className="space-y-6">
              ...
              {/* Детали результатов */}
              <div className="bg-gray-50 rounded-lg p-6">
                <h4 className="font-semibold text-gray-900 mb-4">Детали результатов</h4>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-500">Отвечено</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-900">
              ...
              <div className="bg-blue-50 rounded-lg p-6">
                <h4 className="font-semibold text-blue-900 mb-4">Правильные ответы</h4>
