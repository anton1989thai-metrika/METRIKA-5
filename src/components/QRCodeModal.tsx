...
export default function QRCodeModal({ isOpen, onClose, objectUrl }: QRCodeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white border border-gray-300 rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center">
            <QrCode className="w-6 h-6 text-gray-600 mr-3" />
            <h2 className="text-2xl font-bold text-black">QR-код для быстрого доступа</h2>
          </div>
          <button
            onClick={onClose}
