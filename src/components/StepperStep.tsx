...
export default function StepperStep({
  ...
  // Вычисляем ширину линии: базовая ширина (211px при 3 шагах) минус 10px за каждый дополнительный шаг
  // Расстояние между краями кругов: 250px (между центрами) - 50px (диаметр) = 200px
  // Отступы: 8px с каждой стороны = 16px
  // Базовая ширина при 3 шагах: 200px - 16px = 211px
  const baseWidth = 211; // при 3 шагах
